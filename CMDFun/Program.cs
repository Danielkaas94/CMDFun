...
namespace CMDFun
{
    ...
    "<prod><name>window fan</name><prx>62</prx><qty>8</qty></prod>";
            ...
            //Console.WriteLine(Kyu6.Catalog("saw", s));

            Console.WriteLine(Kyu8.OddCount(1));
            Console.WriteLine(Kyu8.OddCount(3));
            Console.WriteLine(Kyu8.OddCount(7));
            Console.WriteLine(Kyu8.OddCount(15023));
            Console.ReadLine();
